...
?>
        ...
        <h2 class="text-center pt-4" style="color : #E8F1F5; font-size:40px;">Create User</h2>
        <br>
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="img/user3.jpg" style="border: none; border-radius: 50%; background-color : #E8F1F5">
        </div>
        <div class="screen-body-item" style="background-color : #E8F1F5 ; color: #004A7C;">
